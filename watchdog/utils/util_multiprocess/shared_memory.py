...
import struct
import secrets
from watchdog.utils.util_multiprocess.resource_tracker import ResourceTracker
...
class EnhanceSharedMemory:
    ...
    def __init__(self, name=None, create=False, size=0):
        ...
        if _USE_POSIX:
            ...
            # from .util_resource_tracker import register
            # register(self._name, "shared_memory")
            ResourceTracker.register(self._name)
    ...
    def unlink(self):
        ...
        if _USE_POSIX and self._name:
            # from .util_resource_tracker import unregister
...
class ShareableList:
    ...
    def __init__(self, sequence=None, *, name=None):
        ...
        if name is not None and sequence is None:
            self.shm = EnhanceSharedMemory(name)
        else:
            self.shm = EnhanceSharedMemory(name, create=True,
                                           size=requested_size)
